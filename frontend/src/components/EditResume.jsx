...
const EditResume = () => {
    ...
    // ADD NEW ITEM TO ANY ARRAY SECTION
    ...
    // REMOVE ANY ITEM FROM ANY ARRAY SECTION
    ...
    // IT WILL HELP IN CHOOSING THE PREVIEW AS WELL AS HELPS IN DOWNLOADING THE RESUME ALSO SAVES THE RESUME AS IMAGE
    ...
    // SO ALL THIS FUNCTIONS WILL BE USED FOR EDIT RESUME.
                        ...
                        <div className=' p-4 sm:p-6'>
                            ...
                            <div className=' flex flex-wrap items-center justify-end gap-3'>
                                ...
                                <button className={buttonStyles.next} onClick={validateAndNext} disabled={isLoading}>
                                    ...
                                    {currentPage === "addiotionalInfo" ? "Preview & Download" : "Next"}
                                    {currentPage === "additional" && <ArrowLeft size={16} className=' rotate-180' />}
                                </button>
                            </div>
                        </div>
                    </div>
