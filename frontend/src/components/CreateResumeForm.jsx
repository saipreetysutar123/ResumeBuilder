...
const CreateResumeForm = () => {
    ...
    return (
        <div className=' w-full max-w-md p-8 bg-white shadow-lg rounded-2xl border-gray-100'>
            ...
            <form onSubmit={handleCreateResume}>
                <Input value={title} onChange={(e) => setTitle(e.target.value)} label='Resume Title' placeholder='e.g. Software Engineer' type='text'/>
