...
const StepProgress = ({ progress }) => {
    ...
    border border-white/10'>
                ...
                {/* MAIN PROGRESS BAR */}
                <div className=' relative h-full bg-gradient-to-r from-violet-500 to-fuchsia-500 to-violet-600
        ...
        animate-pulse-glow' style={{ width: `${progress}%` }}>
            ...
            animate-shimmer'/>
                    ...
                    <div className=' absolute inset-0'>
                        {[...Array(12)].map((_, i) => (
                            <div key={i} className=' absolte w-1 h-1 bg-white/60 rounded-full'
                                style={{
